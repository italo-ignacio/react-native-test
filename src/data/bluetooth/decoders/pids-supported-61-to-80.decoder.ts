...
export class SupportedPIDs61to80Decoder extends BaseDecoder {
  decode() {
    const bytes = this.rawResponse.match(
      /41 60 ([A-Fa-f0-9]{2}) ([A-Fa-f0-9]{2}) ([A-Fa-f0-9]{2}) ([A-Fa-f0-9]{2})/
    );
    ...
    const start = Number('0x61');
    const end = Number('0x80');
