...
import {
  ...
  DieselParticulateFilterTemperatureDecoder, DistanceTraveledSinceCodesClearedDecoder,
  ...
  EvapSystemVaporPressure2Decoder, EvapSystemVaporPressureDecoder,
  FreezeFrameDecoder,
  ...
  FuelSystemStatusDecoder, FuelTankLevelInputDecoder,
  ...
  VehicleSpeedDecoder,
  VinDecoder, WarmupsSinceCodesClearedDecoder,
} from './decoders';
...
export default {
  ...
  [CharacteristicType.commandedSecondaryAirStatus]:
  CommandedSecondaryAirStatusDecoder,
  [CharacteristicType.oxygenSensorsPresentBanks2]:
  OxygenSensorsPresentBanks2Decoder,
  ...
  [CharacteristicType.oxygenSensorsPresentBanks4]:
  OxygenSensorsPresentBanks4Decoder,
  ...
  [CharacteristicType.oxygenSensor1AFR_CD_Voltage]:
  OxygenSensor1AFRCDVoltageDecoder,
  [CharacteristicType.oxygenSensor2AFR_CD_Voltage]:
  OxygenSensor2AFRCDVoltageDecoder,
  [CharacteristicType.oxygenSensor3AFR_CD_Voltage]:
  OxygenSensor3AFRCDVoltageDecoder,
  [CharacteristicType.oxygenSensor4AFR_CD_Voltage]:
  OxygenSensor4AFRCDVoltageDecoder,
  [CharacteristicType.oxygenSensor5AFR_CD_Voltage]:
  OxygenSensor5AFRCDVoltageDecoder,
  [CharacteristicType.oxygenSensor6AFR_CD_Voltage]:
  OxygenSensor6AFRCDVoltageDecoder,
  [CharacteristicType.oxygenSensor7AFR_CD_Voltage]:
  OxygenSensor7AFRCDVoltageDecoder,
  [CharacteristicType.oxygenSensor8AFR_CD_Voltage]:
  OxygenSensor8AFRCDVoltageDecoder,
  [CharacteristicType.commandedEGR]: CommandedEGRDecoder,
  [CharacteristicType.egrError]: EGRErrorDecoder,
  [CharacteristicType.commandedEvaporativePurge]:
  CommandedEvaporativePurgeDecoder,
  [CharacteristicType.fuelTankLevelInput]: FuelTankLevelInputDecoder,
  [CharacteristicType.warmUpsSinceCodesCleared]:
  WarmupsSinceCodesClearedDecoder,
  [CharacteristicType.distanceTraveledSinceCodesCleared]:
  DistanceTraveledSinceCodesClearedDecoder,
  [CharacteristicType.evapSystemVaporPressure]: EvapSystemVaporPressureDecoder,
  [CharacteristicType.absoluteBarometricPressure]:
  AbsoluteBarometricPressureDecoder,
  ...
  [CharacteristicType.monitorStatusThisDriveCycle]:
  MonitorStatusThisDriveCycleDecoder,
  ...
  [CharacteristicType.relativeThrottlePosition]:
  RelativeThrottlePositionDecoder,
  [CharacteristicType.ambientAirTemperature]: AmbientAirTemperatureDecoder,
  [CharacteristicType.absoluteThrottlePositionB]:
  AbsoluteThrottlePositionBDecoder,
  [CharacteristicType.absoluteThrottlePositionC]:
  AbsoluteThrottlePositionCDecoder,
  [CharacteristicType.acceleratorPedalPositionD]:
  AcceleratorPedalPositionDDecoder,
  [CharacteristicType.acceleratorPedalPositionE]:
  AcceleratorPedalPositionEDecoder,
  [CharacteristicType.acceleratorPedalPositionF]:
  AcceleratorPedalPositionFDecoder,
  [CharacteristicType.commandedThrottleActuator]:
  CommandedThrottleActuatorDecoder,
  [CharacteristicType.timeRunWithMILOn]: TimeRunWithMilOnDecoder,
  [CharacteristicType.timeSinceTroubleCodesCleared]:
  TimeSinceTroubleCodesClearedDecoder,
  [CharacteristicType.maxValuesAFR_Voltage_Current_IMAP]:
  MaxValuesAFRVoltageCurrentIMAPDecoder,
  ...
  [CharacteristicType.absoluteEvapSystemVaporPressure]:
  AbsoluteEvapSystemVaporPressureDecoder,
  [CharacteristicType.evapSystemVaporPressure2]:
  ...
  LongTermSecondaryO2SensorTrimB2B4Decoder,
  [CharacteristicType.fuelRailAbsolutePressure]:
  FuelRailAbsolutePressureDecoder,
  [CharacteristicType.relativeAcceleratorPedalPosition]:
  RelativeAcceleratorPedalPositionDecoder,
  [CharacteristicType.hybridBatteryPackRemainingLife]:
  HybridBatteryBackRemainingLifeDecoder,
  ...
  [CharacteristicType.driversDemandEnginePercentTorque]:
  DriversDemandEnginePercentTorqueDecoder,
  [CharacteristicType.actualEnginePercentTorque]:
  ActualEnginePercentTorqueDecoder,
  ...
  [CharacteristicType.engineCoolantTemperatureSensor]:
  EngineCoolantTempSensorDecoder,
  ...
  [CharacteristicType.engineFriction_PercentTorque]:
  EngineFrictionPercentTorqueDecoder,
  ...
  [CharacteristicType.commandedDieselExhaustFluidDosing]:
  CommandedDieselExhaustFluidDosingDecoder,
